...
export const FEST_CONTENT = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Accommodation inside the CHRIST (Deemed to be University) Bangalore Central Campus is provided on a strict first-come-first-served basis subject to room availability. While you can request accommodation during registration, it is not guaranteed. We also provide recommended verified nearby hotels.",
    },
    {
